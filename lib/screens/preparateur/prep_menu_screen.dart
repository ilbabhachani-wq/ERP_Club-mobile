...
class PrepMenuScreen extends StatelessWidget {
  const PrepMenuScreen({super.key});
  ...
  static const _items = [
    _MenuItem('Programmes', 'Plans d\'entraînement', Icons.fitness_center_rounded, '/preparateur/programmes', _accent),
    _MenuItem('Charge', 'Suivi de charge joueurs', Icons.speed_rounded, '/preparateur/charge', Color(0xFFF59E0B)),
    _MenuItem('Condition', 'Profils physiques', Icons.insights_rounded, '/preparateur/condition', OdinColors.success),
    _MenuItem('Assistant IA', 'Analyse & recommandations', Icons.auto_awesome_rounded, '/preparateur/ia', Color(0xFF22D3EE)),
    _MenuItem('Notifications', 'Alertes & suivis', Icons.notifications_outlined, '/preparateur/notifications', OdinColors.danger),
  ];
    ...
    return OdinBackdrop(
      child: ListView(
        ...
        children: [
          ...
          OdinAnimations.fadeUp(
            Text(
              auth.user?.organization?.clubName ?? 'Préparation Physique',
