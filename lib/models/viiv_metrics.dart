...
class ViivMetrics {
  ...
  ViivMetrics copyWithSource(String label) => copyWith(dataSourceLabel: label);
  ...
  ViivMetrics copyWith({
    ...
    int? fitnessScore,
    bool? fitToPlay,
    List<ViivWeeklyPoint>? weeklyStrain,
    List<ViivHourlyHr>? hourlyHr,
    List<ViivHrZone>? zones,
    List<ViivSyncEvent>? syncLog,
    String? aiInsight,
    List<String>? aiRecommendations,
    int? aiConfidence,
    List<String>? todayGoals,
    ...
    return ViivMetrics(
      ...
      viivEnergy: viivEnergy ?? this.viivEnergy,
      sleepHours: sleepHours ?? this.sleepHours,
      sleepPerformance: sleepPerformance ?? this.sleepPerformance,
      sleepNeed: sleepNeed ?? this.sleepNeed,
      ...
      gpsActivity: gpsActivity ?? this.gpsActivity,
      readiness: readiness ?? this.readiness,
      injuryRisk: injuryRisk ?? this.injuryRisk,
      fitnessScore: fitnessScore ?? this.fitnessScore,
      fitToPlay: fitToPlay ?? this.fitToPlay,
      weeklyStrain: weeklyStrain ?? this.weeklyStrain,
      hourlyHr: hourlyHr ?? this.hourlyHr,
  ...
  factory ViivMetrics.fromJson(Map<String, dynamic> json) {
    return ViivMetrics(
      ...
      dataSourceLabel: json['dataSourceLabel'] as String? ?? 'API',
    );
  }
}
